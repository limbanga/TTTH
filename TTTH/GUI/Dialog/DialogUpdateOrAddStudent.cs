...
namespace TTTH.Views.Dialog
{
    public partial class DialogUpdateOrAddStudent : Form
    {
        ...
        {
            if (BUS.modelStudent is null) { return; }
            if (forAdd) { return; }

            labelHeader.Text = "Cập nhật sinh viên";

            idStudent2Update = BUS.modelStudent.Id;
            textBoxName.Text = BUS.modelStudent.Name;
            textBoxFee.Text = BUS.modelStudent.PhoneNumber;
        }
